...
- [Open Interpreter](https://github.com/KillianLucas/open-interpreter) - Local code execution agent; runs shell commands safely on your machine. Stars: ~30k. Turns natural language into real computer actions with strong local model support. Active community discussions on r/LocalLLaMA.

- [Leon](https://github.com/leon-ai/leon) - Open-source personal assistant; fully offline, privacy-first with speech-to-text and modular skills. Stars: ~17k. Server-based, extensible for custom personal tasks. Official docs at docs.getleon.ai.

- [PrivateGPT](https://github.com/imartinez/privateGPT) - Interact with documents offline, 100% private RAG-style querying. Stars: ~40k. No data leaves your machine; great for personal knowledge bases. Active discussions on r/LocalLLaMA.
